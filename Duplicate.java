...
public class Duplicate {
  ...
  WebElement e1 = driver.findElement(By.id("createLeadForm_companyName"));
  e1.sendKeys("Mindtree");
  ...
  driver.findElement(By.id("createLeadForm_departmentName")).sendKeys("test");
	...
	//submit
		 WebElement e2 = driver.findElement(By.className("smallSubmit"));
		 e2.click();
	...
	WebElement e5 = driver.findElement(By.id("updateLeadForm_description"));
		...
		WebElement element9 = driver.findElement(By.id("createLeadForm_companyName"));
		element9.clear();
		element9.sendKeys("Test_new_Company");
		WebElement el1 = driver.findElement(By.id("createLeadForm_firstName"));
		el1.clear();
		el1.sendKeys("Nivetha");
